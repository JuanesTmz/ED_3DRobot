...
def build_arms(root):
    ...
    # Manopla amarilla de una pieza: los tres dedos sueltos que tenia antes se
    # leian como cuadraditos pegados y ensuciaban la silueta. La palma crece
    # hacia abajo para quedarse con el volumen que aportaban.
    palm = box("hand_L", (0.135, 0.135, 0.185), (0.352, -0.035, 0.467), "yellow", parent=arms)
    thumb = box("thumb_L", (0.048, 0.055, 0.048), (0.296, -0.05, 0.512), "yellow",
                rot=(0, 0, math.radians(18)), parent=arms)

    for ob in (sh, fo, cuff, palm, thumb):
